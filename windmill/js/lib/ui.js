...
windmill.ui = new function() {
    ...
    this.explorerClick = function(e){
        ...
        if (windmill.ui.selectedElement != null){
         windmill.remote.$(windmill.ui.selectedElement).value =  windmill.remote.$("domExp").innerHTML.replace('ID: ','').replace('Name: ','');
        }
    }
    ...
    this.domExplorerOff = function(){
         ...
         windmill.ui.selectedElement = null;
     ...
     this.setRemoteElem = function(id){
       windmill.ui.selectedElement = id;
     }
