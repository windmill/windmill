...
InterpreterManager.prototype.initialize = function () {
    ...
    document.getElementById('interpreter_text').value = 'dir(windmill);';
    this.submit();
...
InterpreterManager.prototype.banner = function () {
    ...
    appendChildNodes("interpreter_output",
        SPAN({"class": "banner"},
            "Windmill Console using MochiKit v" + MochiKit.Base.VERSION,
             " [" + ua + "]",
            BR(),
            "Type your expression in the input box below and press return.\'.",
            BR()
        ),
        BR()
    );
